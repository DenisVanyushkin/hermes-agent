...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("Draw a logo sketch for my project", "artist"),
        ("Edit this photo to look like anime", "artist"),
        ("сгенерируй мне изображение пса шоколадного лабрадора бегущего по степи", "artist"),
        ("сделай в виде аниме", "artist"),
        ("создай мне картинку для обложки", "artist"),
        ("make me a picture of a sunset", "artist"),
        ("переделай фото в акварель", "artist"),
        ("сделай из этого рисунок карандашами", "artist"),
        ("нарисуй портрет в стиле скетча", "artist"),
        ("сделай набросок логотипа", "artist"),
        ("make a pencil drawing of my dog", "artist"),
        ("сгенерируй отчёт по логам", "general_operator"),
        ("make the deploy script faster", "engineer"),
