...
class EmailAdapter(BasePlatformAdapter):
    ...
    def __init__(self, config: PlatformConfig):
        ...
        # Bounded IMAP socket timeout: without it a half-open connection to the
        # mail host blocks the poll thread forever and leaks the connection.
        self._imap_timeout = _esecret_int("EMAIL_IMAP_TIMEOUT", DEFAULT_IMAP_TIMEOUT)
    ...
    async def connect(self, *, is_reconnect: bool = False) -> bool:
        ...
        try:
            ...
            try:
                ...
                if imap is not None:
                    _close_imap(imap)
                    # The outer legacy finally also invokes a compatibility
                    # cleanup helper. Avoid a second logout on this handle.
                    imap = None
    ...
    def _fetch_new_messages(self) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            try:
                ...
                _close_imap(imap)
                # The outer legacy finally also invokes its compatibility
                # cleanup helper. Mark this handle consumed so a failed
                # connect issues one graceful logout, not two.
                imap = None
        except Exception as e:
