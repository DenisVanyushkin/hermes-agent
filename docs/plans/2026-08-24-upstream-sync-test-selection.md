...
- **Ограничение механического `merge-both`.** Склейка независимых top-level
  добавлений допустима, но конкатенация двух версий тела функции может дать
  синтаксически валидный, частично недостижимый и семантически бессмысленный
  код. Для конфликтов внутри тела функции нужна явная ручная резолюция с
  проверкой AST на отсутствие мёртвого хвоста и с поведенческими тестами;
  автоматическая валидность результата не является доказательством корректности.
