...
_BUILTIN_SUBCOMMANDS = frozenset(
    {
        ...
        "project", "proxy",
        "prompt-size",
        "recruiter-context", "recruiter-decision", "recruiter-document", "recruiter-skill",
        "resume",
        "send", "sessions", "setup",
...
def main():
    ...
    # =========================================================================
    # recruiter-context command — safe recruiter dry-run JSON entrypoint
    # =========================================================================
    ...
    # =========================================================================
    # recruiter-document command — controlled draft-only document execution CLI
    # =========================================================================
    from hermes_cli.recruiter_document_execution_cli import register_recruiter_document_subparser
