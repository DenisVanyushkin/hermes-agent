    ...
    return [
        ...
        },
        {
            ...
            "content": (
                ...
                '}\n\n'
                'Example C - application package / recruiter materials prompt:\n'
                'Input: "подготовь мне пакет документов для вакансии" (reply under a job posting)\n'
                '{\n'
                '  "status": "selected",\n'
                f'  "selected_pipeline_id": "{RECRUITER_PIPELINE_ID}",\n'
                '  "fallback_pipeline_id": null,\n'
                '  "confidence": 0.9,\n'
                '  "requires_clarification": false,\n'
                '  "fallback_safe": false,\n'
                '  "reasoning_summary": "The user asks to prepare application materials (CV, cover letter, recruiter message) for a specific vacancy, which is the recruiter pipeline\'s application-package flow."\n'
                '}\n\n'
                'Example C2 - generic career chat without a vacancy or materials request:\n'
                'Input: "как думаешь, стоит ли мне вообще менять работу?"\n'
                '{\n'
                '  "status": "no_specialized_pipeline",\n'
                '  "selected_pipeline_id": null,\n'
                '  "fallback_pipeline_id": "default_conversation_pipeline",\n'
                ...
                '  "requires_clarification": false,\n'
                '  "fallback_safe": true,\n'
                '  "reasoning_summary": "General career reflection without a concrete vacancy or materials request stays on the default pipeline."\n'
                '}\n\n'
