...
def invoke_tool(agent, function_name: str, function_args: dict, effective_task_id: str,
    ...
    if function_name == "todo":
        ...
        def _execute(next_args: dict) -> Any:
            ...
            # Context-local dispatch: a pipeline bridge restricts which tools
            # its own conversation may call, and that restriction must not leak
            # into concurrent sessions in other threads. Falls through to the
            # global dispatcher when no bridge is active.
