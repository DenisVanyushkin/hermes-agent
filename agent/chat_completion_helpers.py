...
def build_api_kwargs(agent, api_messages: list, tools_for_api: list | None = None) -> dict:
    ...
    if runtime_api_mode == "codex_responses":
        ...
        return _ct.build_kwargs(
            ...
            # The runtime provider, not agent.provider: after a fallback swap
            # the request goes to the runtime one, and this value gates a
            # provider-specific reasoning-effort clamp in the codex transport.
    ...
    _is_nous = base_url_host_matches(runtime_base_url, "nousresearch.com")
    _is_nvidia = base_url_host_matches(runtime_base_url, "integrate.api.nvidia.com")
    _is_kimi = (
